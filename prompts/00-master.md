...
10. **Differential oracles.** Emulator vs qemu-riscv32/spike (per-instruction register traces). Curve/pairing vs arkworks committed fixtures. Every lookup table vs a reference ISA-level recomputation. Comparison/borrow encodings verified exhaustively at reduced width.
