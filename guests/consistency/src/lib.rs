...
//!   it is the one workload the QEMU leg runs, and the bound was set when that
//!   comparison read a register file per instruction rather than the guest's
//!   output. Every other workload's budget is the three-way suite's
