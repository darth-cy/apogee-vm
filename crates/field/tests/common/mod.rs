//! Shared test support: a seeded RNG, hex, arkworks conversion, and SHA-256 for
//! pinning committed fixtures. Test-only; never compiled into the library.
#![allow(dead_code)]
...
// Verified against the NIST "abc" and empty-string vectors in tests/kat.rs.
// ---------------------------------------------------------------------------
